...
place_table_id = br_client.get_table_by_name(BASEROW_DB_ID, "districts")


items = []
filters = {"filter__field_12556__contains": "https", "filter__field_23748__empty": True}
...
for x in tqdm(items):
    ...
    gn_object = gn_as_object(x["geonames_id"])
